...
Data = importdata("Botswana_second_fault_latlon.dat");
Data = Data.data;
lat = Data(:,1);
lon = Data(:,2);

%Get utm coordinates for the seconf fault
fileID = fopen('Botswana_second_fault_utm.dat','w');
fprintf(fileID,'%s\t%s\t\n','X','Y');
for(i=1:length(lat))
...
Data2 = importdata("Botswana_second_fault_utm.dat");
Data2 = Data2.data;
X = Data2(:,1);
Y = Data2(:,2);
X = X - x_0;
...
fileID2 = fopen('Final_second_fault_utm.dat','w');
